...
| <img src="https://danilw.github.io/GLSL-howto/vulkan_sh_launcher/images_bugs/ftXXW4.png" width="650" height="auto" /> | [BUG 32-bit float precision test](https://www.shadertoy.com/view/ftXXW4) - Look function `colorAniso()` in shader, for some reason this noise happens when camera look on plane. Source of this behaviour is same why length of normalized vector not equal 1. Also I use this shader to compare 32bit floats vs 64 bit floats. (more shaders to compare float vs double [quartic_double.zip](https://danilw.github.io/GLSL-howto/vulkan_sh_launcher/quartic_Intersection_double.zip) screenshot [quartic_double.png](https://danilw.github.io/GLSL-howto/vulkan_sh_launcher/quartic_Intersection_double.png), other [numerical_approx_cubic_bezier.zip](https://danilw.github.io/GLSL-howto/vulkan_sh_launcher/numerical_approximation_cubic_bezier.zip) screenshot [numerical_approx_cubic_bezier.jpeg](https://danilw.github.io/GLSL-howto/vulkan_sh_launcher/umerical_approximation_cubic_bezier.jpeg) (shadertoy link in shader file main_image.glsl) ) |
