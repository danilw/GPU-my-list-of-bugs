...
| <img src="https://danilw.github.io/GLSL-howto/vulkan_sh_launcher/images_bugs/Xc23DW_1.jpg" width="650" height="auto" /> | [BUG TEST Rough Seas fract hash](https://www.shadertoy.com/view/Xc23DW) - Just test shader for this blog post [**Hash Noise stability in GPU Shaders**](https://arugl.medium.com/hash-noise-in-gpu-shaders-210188ac3a3e). |
| <img src="https://danilw.github.io/GLSL-howto/vulkan_sh_launcher/images_bugs/4fSXDd.png" width="650" height="auto" /> | Related-example of fract-hash instability described in blog post [**Hash Noise stability in GPU Shaders**](https://arugl.medium.com/hash-noise-in-gpu-shaders-210188ac3a3e). [Shader link](https://www.shadertoy.com/view/4fSXDd). |
