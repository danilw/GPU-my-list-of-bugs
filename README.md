...
| <img src="https://danilw.github.io/GLSL-howto/vulkan_sh_launcher/images_bugs/MfsBz8.jpg" width="650" height="auto" /> | [BUG AMD performance dFd if ruin](https://www.shadertoy.com/view/MfsBz8) - When this specific shader run in 32-bit buffer - it get 1000x slowdown because use of fwidth/dFd and if condition after - idk it so weird, when it run in 8-bit buffer - its fine no slowdown, related to shader compiler I think. |
