...
[Chrome Vulkan: Fix line-loop draw arrays after elements]([https://youtu.be/Bug2vGm9HZI](https://issues.chromium.org/issues/40911000)) - Google confirmed and fixed one Vulkan related bug in their browser.
